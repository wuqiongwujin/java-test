...
//            if (row == 1) continue;
        ...
        String filePatch = "/Users/wuqiong/Downloads/UseFunctionStatistic2.xls";
        ...
        List<String> titles = new ArrayList<>(Arrays.asList("公司ID","公司名称","是否设置等级规则","等级规则内容",
                "是否有生效中交易送积分规则","是否有多个生效中交易送积分规则","是否开通储值卡","在用且有有余额的储值卡张数",
                "是否有生效中的微盟店铺","现有会员数","有储值余额会员数","标签数","业务员数","erp会员数","营销活动数",
